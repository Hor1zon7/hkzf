...
@section('content')
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
                    ...
                    class="btn btn-primary radius" data-title="添加资讯" data-href="{{url('admin/article/create')}}"
                    onclick="Hui_admin_tab(this)" href="javascript:;"><i
                        class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span>
    ...
    <script type="text/javascript">
        ...
        $("#DataTable").dataTable({
            ...
            "dataSrc": 'data',
            ajax: {
                url: "{{url('admin/getArticle')}}",
                type: 'get',
            },
            columns: [
                {data: "", defaultContent: "<input type='checkbox' value='' name=''>"},
                {data: 'id'},
                {data: 'title'},
                {data: 'created_at'},
        ...
        function article_edit(id) {
            var index = layer.open({
                type: 2,
                title: 'title',
                content: "http://www.hkzf.com/admin/article/"+id+"/edit"
            });
            layer.full(index);
        }
        ...
        function article_del(obj, id) {
            layer.confirm('确认要删除吗？', function (index) {
                $.ajax({
                    type: 'DELETE',
                    url: 'http://www.hkzf.com/admin/article/' + id,
                    headers: {
