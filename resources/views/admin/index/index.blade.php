...
<head>
    ...
    <script type="text/javascript"
            src="/admin/lib/DD_belatedPNG_0.0.8a-min.js"></script>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        @foreach($list as $item)
            <dl id="menu-admin">
                <dt><i class="Hui-iconfont">&#xe62d;</i> {{$item['node_name']}}<i
                        class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
                <dd>
                    <ul>
                        @foreach($item['son'] as $v)
                            <li><a data-href="{{url($v['route'])}}" data-title="{{$v['node_name']}}"
                                   href="javascript:void(0)">{{$v['node_name']}}</a></li>
                        @endforeach
                    </ul>
                </dd>
            </dl>
