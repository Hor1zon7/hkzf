    ...
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="sex" type="radio" @if($data['sex']=='男') checked @endif value="1" id="sex-1" checked>
                    <label for="sex-1">男</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2"  @if($data['sex']=='女') checked @endif value="0" name="sex">
        ...
        <div class="row cl">
			...
			<select class="select" name="role" size="1">
				<option value="1" @if($data['get_role']['id']=='1') selected @endif>超级管理员</option>
				<option value="2" @if($data['get_role']['id']=='2') selected @endif>总编</option>
				<option value="3" @if($data['get_role']['id']=='3') selected @endif>栏目主辑</option>
				<option value="4" @if($data['get_role']['id']=='4') selected @endif>栏目编辑</option>
			</select>
			</span></div>
        </div>
        <div class="row cl">
    ...
    $(function () {
        ...
        $("#form-admin-add").validate({
            ...
            submitHandler: function (form) {
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "http://www.hkzf.com/admin/adminDoEdit",
