...
<div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
            ...
            <a href="javascript:;" onclick="admin_add('添加管理员','{{route('admin.adminAdd')}}','800','500')"
               class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>添加管理员</a></span> <span class="r">共有数据：<strong></strong> 条</span>
</div>
<table class="table table-border table-bordered table-bg" id="datatables">
    ...
    @foreach($data as $item)
        <tr class="text-c">
            ...
            <td>{{$item->username}}</td>
            <td>{{$item->phone}}</td>
            <td>1700892756@qq.com</td>
            <td>{{$item->getRole->roleName}}</td>
            ...
            <td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')"
                    ...
                    onclick="admin_edit('管理员编辑','{{route('admin.adminEdit',['id'=>$item->id])}}','1','800','500')"
