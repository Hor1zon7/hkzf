...
<div class="page-container">
    ...
    <p>登录次数：18 </p>
    <p>上次登录IP：{{request()->ip()}} 上次登录时间：2014-6-14 11:19:55</p>
...
<script>
    ...
    // 绘制图表
    // 假设主题名称是 "vintage"
    // $.getJSON('/theme/purple-passion.project.json', function (themeJSON) {
    //     echarts.registerTheme('swift', JSON.parse(themeJSON));
    //     // var chart = echarts.init(dom, 'swift');
    // });
        ...
        series: [
            {
                ...
                type: 'pie',
                data: [
                    {value: {{$onCount}}, name: '已出租'},
                    {value: {{$offCount}}, name: '未出租'},
                ]
            }
        ]
    });
