...
<div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
            ...
            <a href="javascript:;" onclick="house_add('添加房东','{{url('admin/fangowner/create')}}','800','500')"
               class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>添加房东</a>
    <a href="{{url('admin/fangownerExcel')}}" onclick=""
...
<table class="table table-border table-bordered table-bg" id="datatables">
    <thead>
    <tr>
        <th scope="col" colspan="10">房东列表</th>
    </tr>
    <tr class="text-c">
    ...
    @foreach($data as $item)
        <tr class="text-c">
            ...
            <td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')"
                    ...
                    onclick="admin_edit('房东编辑','{{url('/admin/fangowner/'.$item->id.'/edit')}}','{{$item->id}}','800','500')"
                    class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>

                <a title="删除" href="javascript:;" onclick="admin_del(this,{{$item->id}})" class="ml-5"
                   style="text-decoration:none">
                    <i class="Hui-iconfont">&#xe6e2;</i></a>
                <button onclick="checkPhoto('{{url("admin/checkPhoto?id=$item->id")}}')" >查看图片</button>
    ...
    */
    ...
    function admin_del(obj, id) {
        ...
        layer.confirm('确认要删除吗？', function (index) {
            $.ajax({
                type: 'DELETE',
                url: 'http://www.hkzf.com/admin/fangowner/'+id,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
                },
                data: {
