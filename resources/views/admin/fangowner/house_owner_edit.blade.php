...
@section('content')
    <article class="page-container">
        <form class="form form-horizontal" id="form-article-add" action="{{url('admin/fangowner/'.$data->id)}}">
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$data->card}}" placeholder="" id="card" name="card">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$data->address}}" placeholder="" id="loc"
                           name="address">
                </div>
            </div>
            @csrf
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    男<input type="radio" name="sex" @if($data->sex=='男') checked @endif value="男">
                    女<input type="radio" name="sex" @if($data->sex=='女') checked @endif value="女">
                </div>
            </div>
