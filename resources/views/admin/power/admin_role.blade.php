...
<link rel="stylesheet" type="text/css" href="{{asset(__ADMIN_STATIC__)}}/h-ui.admin/skin/default/skin.css" id="skin" />
	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td></td>
				<td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_role_edit('角色编辑','{{url("/admin/role/".$item['id']."/edit")}}','1')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_role_del(this,{{$item['id']}})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
            @endforeach
...
<script type="text/javascript" src="{{asset(__ADMIN_STATIC__)}}/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
...
function admin_role_del(obj,id){
	...
	layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
		$.ajax({
			...
			url: 'http://www.hkzf.com/admin/role/'+id,
			dataType: 'json',
...
function datadel() {
        ...
        // 发送ajax请求批量删除
        $.ajax({
            url: 'http://www.hkzf.com/admin/delMany',
            data: {
                id: id
            },
            headers: {
